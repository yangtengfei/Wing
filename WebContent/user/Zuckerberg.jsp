...
/*浮动end*/
		...
		<title>你们眼中的我是这样的吗？欢迎围观拍砖！才储分析：我是INTJ 专家型——追求能力与独立......</title> <script
...
<body>
	<div id="report">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tbody>
				<tr>
					<td width="180" style="padding-top: 2px;"><a
						href="http://www.apesk.com/" target="_blank"><img
							src="image /logo_normal_touming.gif" border="0" alt="才储，敢于做自己"></a>
					</td>
					<td></td>
		...
		<br>
			...
			</p> <!--   <a href="/mbti2/mbti_step_two.asp"target="_blank"><img src="/mensa/img/orange-apple-report1.gif" id="titlePic" border="0"/> </a>-->
			...
			</script> <!-- <form name="pdfform" target="_blank" action='http://www.hrreserve.com/packagetmp/url2pdfs.asmx/URL2PDF' method="POST" onsubmit="return formcheck()">               
<input type="hidden"   name="urlToConvert" value='www.apesk.com/mbti/submit_email_date.asp?user=6301636'>
 <input name="pdfsubmit" type="submit" value="生成/下载报告PDF"> 
				...
				<h3 align="center">INTJ 专家型——追求能力与独立</h3> <!--新标题end--> <br> <br>
						...
						<div class="r">
							<table>
								<tbody>
									<tr>
										<td><b>报告接收人:</b></td>
										<td width="130">才储成员6301636</td>
										<td><b>日期:</b></td>
										<td width="120">2015/9/22</td>
									</tr>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<div class="graph" id="two">
													<strong class="bar" style="width: 70.00%;"><span></span></strong>
												</div> <br><br>
											</td>
											<td>（I）内向</td>
										</tr>
										<tr>
											...
											<td>
												...
												<div class="graph" id="two">
													<strong class="bar" style="width: 44.00%;"><span></span></strong>
												</div> <br><br>
											</td>
											<td>（N）直觉</td>
										</tr>
										<tr>
											...
											<td>
												<div class="graph2" id="one">
													<strong class="bar" style="width: 21.74%;"><span></span></strong>
												</div>
												<div class="graph" id="two">
													<strong class="bar" style="width: 0;"><span></span></strong>
												</div> <br><br>
										...
										<tr>
											...
											<td>
												<div class="graph2" id="one">
													<strong class="bar" style="width: 60.00%;"><span></span></strong>
												</div>
												<div class="graph" id="two">
													<strong class="bar" style="width: 0;"><span></span></strong>
												</div> <br><br>
										...
										<tr>
											<td height="34"></td>
											<td
												style="background: url(/lee/images/dibiao1.jpg) no-repeat"></td>
											<td></td>
										</tr>
									</tbody>
								</table> <br><p></p>
																...
																<tr>
																	<td class="style123">
																		...
																		<table style="FLOAT: left; MARGIN: 0px 25px 10px 0px"
																			width="200" bgcolor="#dddddd" cellpadding="0"
																			cellspacing="5">
																			<tbody>
																				<tr>
																					<td><img align="center" width="200" alt=""
																						style="border: 1px solid #333333;"
																						src="../user/image/INTJ.jpg"></td>
																				</tr>
																				<tr>
																					<td
																						style="FONT-SIZE: 9pt; LINE-HEIGHT: 12pt; FONT-FAMILY: Arial, 宋体; font-weight: none; color: #2F4F4F">
																						<br> INTJ (Introverted Intuition with
																							Thinking)代表人物：<br><br> 扎克伯格 facebook创始人<br><br>
																		...
																		<p id="P1">
																			才储分析：您的性格类型倾向为“ INTJ ”(内向 直觉 思维 判断&nbsp;<b>倾向度：</b>
																			I85 N72 T61 J80&nbsp; 不假思索指数：13)
																		</p>
																		<p id="P2">在实现自己的想法和达成自己的目标时有创新的想法和非凡的动力。能很快洞察到外界事物间的规律并形成长期的远景计划。一旦决定做一件事就会开始规划并直到完成为止。多疑、独立，对于自己和他人能力和表现的要
																			求都非常高。</p>
																		<p id="P3">INTJ型的人是完美主义者。他们强烈地要求个人自由和能力，同时在他们独创的思想中，不可动摇的信仰促使他们达到目标。
																			INTJ型的人思维严谨、有逻辑性、足智多谋，他们能够看到新计划实行后的结果。他们对自己和
																			别人都很苛求，往往几乎同样强硬地逼迫别人和自己。他们并不十分受冷漠与批评的干扰，作为所有性格类型中最独立的，INTJ型的人更喜欢以自己的方式行事。面对相反意见，他们通常持怀疑态度，十分坚定和坚决。权
																			威本身不能强制地们，只有他们认为这些规则对自己的更重要的目标有用时，才会去遵守。
																			INTJ型的人是天生的谋略家，具有独特的思想、伟大的远见和梦想。他们天生精于理论，对于复杂而综合的概念运转灵活。他们是
																			优秀的战略思想家，通常能清楚地看到任何局势的利处和缺陷。对于感兴趣的问题，他们是出色的、具有远见和见解的组织者。如果是他们自己形成的看法和计划，他们会投入不可思议的注意力、能量和积极性。领先到达
																			或超过自己的高标准的决心和坚忍不拔，使他们获得许多成就。</p>
																		<p id="P4">
																			<script src="js /lianjie.js"></script>
																		...
																		<p id="P6">
																			· 首席财政执行官<br> · 知识产权律师<br> · 设计工程师<br>
																						· 精神分析师 <br> · 心脏病专家<br> · 媒体策划<br>
																									· 网络管理员<br> · 建筑师<br> · 管理顾问<br>
																												· 经济学者<br> · 国际银行业务职员<br> · 金融规划师<br>
																															· 综合网络专业人员<br> · 各类科学家<br> ·
																																	研究所研究人员<br> · 系统分析员 <br> ·
																																			计算机程序员 <br> · 研究开发部经理<br> ·
																																					各类技术顾问<br> · 技术专家<br> ·
																																							投资专家<br> · 法律顾问<br> ·
																																									医学专家<br> · 经济学家<br> ·
																																											投资银行研究员<br> · 证券投资和金融分析员<br>
																																													· 投资银行家<br> · 财务计划人<br>
																																															· 企业并购专家<br> · 各类发明家<br>
																																																	· 建筑师<br> · 社论作家<br>
																																																			· 艺术家
																				...
																				<p></p> <br> <br> <br> 根据大卫.凯尔西（David
																							Keirsey）气质与性情理论，你属于“<b>概念主义者</b>”，下面是对“<b>概念主义者</b>”的描述：<br>
																								<br>
																									...
																									“概念主义者”型的人自信、有智慧、富有想像力。他们的原则是“所有的事情都要做到最好”。<br><br>
																											...
																											遇和批评干扰，喜欢以自己的方式做事。<br><br>
																													...
																													物的复杂性，喜欢进行逻辑的分析，从而对真实或假设的问题构思出解决方案。<br><br>
																															...
																															者”型的人推崇权力，易于被有权力的人和权力地位所吸引。<br> <br>

																																	<b>总体描述</b> <br> <br> 1.
																																			善于分析、总结、判断<br> 2. 善于从整体上把握事物<br>

																																					3. 喜欢追根究底，力图抓住事物的本质<br> 4.
																																						对文字、语言敏感<br> 5.
																																							抽象思维能力强，能理解复杂的理论概念，善于将事情概念化，善于从中推断出原则或预测趋势<br>

																																								6. 擅长策略性思维<br> 7.
																																									会接受建设性的批评，而不把它当作针对个人的问题<br>
																																										<br> <b>潜在的弱点 </b><br>
																																												<br> 1.
																																													由于有时给自己定了不切实际的高标准，可能对自己和他人的期望过高<br>

																																														2. 易于像紧逼自己工作一样去逼着别人工作<br>

																																															3.
																																															常常不希望别人对抗自己的意愿，有时给人顽固、死板的印象<br>
																																																...
																																																4. 易于过份强调工作，从而损害了家庭的和谐 <br>
																																																	...
																																																	5. 常常不记得花时间夸奖同事、下属或其他人<br>
																																																		...
																																																		6. 常常忽视了一些工作中所需要的社交礼仪<br>
																																																			...
																																																			7.
																																																			有时没有注意到他人的情绪感受，从而给人冷漠、不近人情的印象<br>

																																																				8.
																																																				有时会因忽略了细节而没有注意到周围环境的变化<br>

																																																					9.
																																																					易于过于理论化而不考虑实际情况，易受远景规划诱惑，难以具体落实<br>

																																																						10.
																																																						有时想法太多，不知道哪些切实可行，不知道真正应该做什么
																																																								...
																																																								<p></p> <br>
																																																									<br>
																																																										...
																																																										<br> <br>
																																																												...
																																																												<p
																																																													style="BORDER-BOTTOM: 1px dashed #dddddd;"></p>
																																																												...
																																																												<br>
																																																													...
																																																													<p
																																																														class="STYLE11"
																																																														style="text-indent: 2em">面对挑战时的反应，是你意志是否坚定的终极体现。实际上，随着情况变得日益艰难，你发现自己投入了更多热情、更多自我。你发现自己在竞争中面对的问题不是威胁而是刺激。你的兴趣不仅仅是获胜。很明显，你生来就热爱战斗。鉴于这种情绪反应，你已经成为优秀的问题解决者。其他人在问题开始暴露时惟恐避之而不及，而你却在内心中微笑，因为你知道自己已经掌握了心理优势。</p>
																																																													<p
																																																														align="right"
																																																														class="STYLE11">————
																																																														罗尔</p> <br>
																																																														...
																																																														<br>
																																																															...
																																																															<li><b><img
																																																																	src="image /new.gif">温馨提示：</b><span
																																																																class="STYLE11"><b>
																																																																		若希望更全面了解自己及发展建议，可以继续参与<a
																																																																		id="step2link"
																																																																		style="font-size: 29px;"
																																																																		class="a-tips-Article-QQ"
																																																																		href="http://www.apesk.com/mbti2/mbti_step_two.asp?formlink=6301636"
																																																														...
																																																														<b><br>
																																																																	<br>
																																																																		...
																																																																		<br>
																																																																			...
																																																																			<li>
																																																																				<b>
																																																																					即将面临高考专业选择的同学，</b>可以继续参与<a
																																																																				id="step2link"
																																																																				style="font-size: 29px;"
																																																																				class="a-tips-Article-QQ"
																																																																				href="http://www.apesk.com/mbti2/zyxz_two.asp?formlink=mbti"
																																																																				target="_blank"><b>APESK专业选择评估测试</b></a>
																																																																		</li> <br><br>

																																																																					<li><span
																																																																						class="STYLE11">若您是<a
																																																																							id="hrlink"><b>HR(企业人力资源)</b></a>，可以继续<a
																																																																							class="a-tips-Article-QQ"
																																																																							style="font-size: 29px"
																																																																							href="http://www.apesk.com/mbti_step2/mbti2_common_hr/admin/index.asp?userid="
																																																																							target="_blank"><b>了解MBTI在人才招聘选拔中的应用</b></a></span>
																																																																				</li>
																																																																				<br>
																																																																						<br>
																																																																							...
																																																																							<li><span
																																																																								class="STYLE11"><b>你可能感兴趣的：</b><a
																																																																									id="step2link"
																																																																									class="a-tips-Article-QQ"
																																																																									href="http://www.apesk.com/mbti/love/who-is-your-lover-pro.asp?code=223.73.241.5&user=6301636"
																																																																									target="_blank"><b
																																																																										style="font-size: 29px">谁是最适合你的异性？</b></a>
																																																																							</span></li>
																																																																						<br><br>
...
<img src="/mensa/img/holland-m.png" width="150"></span></li><br /><br />-->
																																																																									...
																																																																									<li><span
																																																																										class="STYLE11"><b>你可能感兴趣的：
																																																																										</b><a
																																																																											class="a-tips-Article-QQ"
																																																																											href="http://www.apesk.com/my/?m=18896948556"
																																																																											target="_blank"><strong
																																																																												style="font-size: 29px">加入才储人才储备库！</strong></a></span></li>
																																																																									<br>
																																																																										<br>
																																																																											...
																																																																											<li><span
																																																																												class="STYLE11"><b>你可能还感兴趣的：</b><a
																																																																													class="a-tips-Article-QQ"
																																																																													href="http://www.apesk.com/xinliceshi/"
																																																																													target="_blank"><strong
																																																																														style="font-size: 29px">更多靠谱心理测试！</strong></a></span></li>
																																																																											<br>
																																																																												<br>
																																																																													<li><span
																																																																														class="STYLE11"><b>大胆预测：</b>你感兴趣小众网站！<a
																																																																															class="a-tips-Article-QQ"
																																																																															href="http://www.apesk.com/gate/?type=NT&code=223.73.241.5&user=6301636"
																																																																															target="_blank">
																																																																																<strong
																																																																																style="font-size: 29px">猛戳看看准不准！</strong>
																																																																														</a></span></li>
																																																																												<br>
																																																																														<br>
																																																																															<li><span
																																																																																class="STYLE11"><b>你可能感兴趣的：</b><a
																																																																																	id="step2link"
																																																																																	class="a-tips-Article-QQ"
																																																																																	href="http://www.apesk.com/mbti2/rongge"
																																																																																	target="_blank"><b
																																																																																		style="font-size: 29px">荣格八维测试！</b></a>
																																																																															</span></li>
																																																																														<br><br>
																																																																																	...
																																																																																	<br>
																																																																																		<br>
																																																																																			...
																																																																																			<p
																																																																																				align="right">
																																																																																				本测试微信二维码：<img
																																																																																					src="image /dati_m.png"
																																																																																					width="100"><br>

																																																																																						本测试地址：<a
																																																																																						href="http://www.apesk.com/mbti/dati.asp"
																																																																																						target="_blank"
	...
	<div class="bdshare-slide-button-box bdshare-slide-style-r6"
		style="top: 100px; width: 0px; z-index: 99999; right: 0px;"
		data-bd-bind="1461837979206">
		<a
			href="http://www.apesk.com/mbti/submit_email_date.asp?code=223.73.241.5&user=6301636#"
