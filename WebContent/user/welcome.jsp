...
<body class="home-layout " onbeforeunload="checkLeave()">
	<header class="">
	<div class="err-top">
		<i class="err-close"> <i class="icon-remove"> </i>
		</i>
		<div class="err-out">
			<div class="err-switch">
				<i class="err-switch-i icon-smile"> </i> <i
					class="err-switch-i icon-frown"> </i> <span class="err-content">
				</span>
			</div>
		</div>
	</div>
	<div class="nav-left">
		<a href="http://www.apicloud.com/" class="logo"
			title="APICLOUD-重新定义APP移动应用开发工具"> </a>
	</div>
	<div class="nav-right mw-8">
		<div class="nav-right">

			<div class="unauthenticated">
				<a id="login" style="cursor: pointer"> 登录 <input type="hidden"
					id="message" value=${data.status }>
				</a> <span> </span> <a id="reg" style="cursor: pointer"> 注册 </a>
			</div>

		</div>
		<ul class="nav nav-right">
			<li><a href="javascript:void(0)"> 职业分析 </a>
				<ul class="nav-list">
					<li class="nav-list-item"><a href="工作经验与工资关系.html"
						class="nav-link" target="_blank">
							<div class="nav-left icon">
								<span class="i_superwebview"> </span>
							</div>
							<div class="nav-left">
								<span class="nav-title"> 经验和工资 </span> <span
									class="nav-description"> </span>
							</div>
					</a></li>
					<li class="nav-list-item"><a href="软件工程师工资分布.html"
						class="nav-link" target="_blank">
							<div class="nav-left icon">
								<span class="i_deepengine"> </span>
							</div>
							<div class="nav-left">
								<span class="nav-title"> 软件工程师和工资 </span>
							</div>
					</a></li>
					<li class="nav-list-item"><a href="软件工程师学历要求分布.html"
						class="nav-link" target="_blank">
							<div class="nav-left icon">
								<span class="i_cloudservice"> </span>
							</div>
							<div class="nav-left">
								<span class="nav-title"> 学历和软件工程师 </span>
							</div>
					</a></li>
				</ul></li>
			<li><a href="http://localhost:8080/Wing/user/question.jsp"
				target="_blank" style="cursor: pointer"> 职业测试 </a></li>
		</ul>
	</div>
	</header>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/Wing/user/register" method="post">
						...
						<div class="form-group">
							<label for="message-text" class="control-label">电话:</label> <input
								type="text" class="form-control" id="phone" name="phone">
						</div>
						<input type="submit" class="btn btn-primary"
							style="background-color: rgb(137, 174, 0); float: right;">
					</form>
				</div>
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" style="margin-top: 20%">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
